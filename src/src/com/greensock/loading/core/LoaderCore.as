...
package com.greensock.loading.core {
    ...
    public class LoaderCore extends EventDispatcher {
        ...
        public function LoaderCore(vars:Object=null){
            ...
            this._cachedBytesTotal = (("estimatedBytes" in this.vars)) ? uint(this.vars.estimatedBytes) : LoaderMax.defaultEstimatedBytes;
        ...
        protected function _dump(scrubLevel:int=0, newStatus:int=0, suppressEvents:Boolean=false):void{
            ...
            if ((((this._status == LoaderStatus.PAUSED)) && (!((newStatus == LoaderStatus.PAUSED))))){
            ...
            if (((((this._dispatchProgress) && (!(suppressEvents)))) && (!((this._status == LoaderStatus.DISPOSED))))){
        ...
        override public function addEventListener(type:String, listener:Function, useCapture:Boolean=false, priority:int=0, useWeakReference:Boolean=false):void{
            if (type == LoaderEvent.PROGRESS){
                ...
                if ((((type == LoaderEvent.CHILD_PROGRESS)) && ((this is LoaderMax)))){
        ...
        override public function toString():String{
			var str:String="";
			try{
				str = (((((this._type + " '") + this.name) + "'") + ((this is LoaderItem)) ? ((" (" + (this as LoaderItem).url) + ")") : ""));
